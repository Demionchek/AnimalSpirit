...
namespace Features.Player.Domain
{
    ...
    public readonly struct PlayerShapeChanged { public readonly Shape Shape; public PlayerShapeChanged(Shape s) => Shape = s; }
    ...
    public readonly struct PlayerControlStateChanged { public readonly bool IsEnabled; public PlayerControlStateChanged(bool isEnabled) { IsEnabled = isEnabled; } }
    public readonly struct PlayerShapeUnlocked { public readonly Shape Shape; public PlayerShapeUnlocked(Shape shape) { Shape = shape; } }
}